...
export const ADMIN_EARNED_BADGE_PRESETS: AdminEarnedBadgePreset[] = [
    {
        ...
        iconType: 'single',
        iconMainUrl: '/assets/badges/first-exchange.svg',
    },
    {
        key: 'active-member',
        name: 'Active Member',
        ...
        iconType: 'single',
        iconMainUrl: '/assets/badges/active-member.svg',
    },
    {
        key: 'skill-exchanger',
        ...
        iconType: 'single',
        iconMainUrl: '/assets/badges/skill-exchanger.svg',
    },
    {
        key: 'experienced',
        name: 'Experienced',
        ...
        iconType: 'single',
        iconMainUrl: '/assets/badges/experienced.svg',
    },
    {
        ...
        iconType: 'single',
        iconMainUrl: '/assets/badges/core-contributor.svg',
    },
]
