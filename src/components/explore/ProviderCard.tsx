      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-white rounded-[5px] shadow-lg p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            <div className="w-12 h-12 sm:w-15 sm:h-15 rounded-full bg-gray-200 flex-shrink-0 animate-pulse" />
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white rounded-[5px] shadow-lg p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
          <div className="w-12 h-12 sm:w-15 sm:h-15 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 flex-shrink-0 flex items-center justify-center overflow-hidden">
            <img src={image} alt={userName} className="w-full h-full object-cover" />
          </div>

          <div className="flex-1">
            <p className="text-text-primary text-lg sm:text-xl font-semibold">{userName}</p>
            {bio ? <p className="text-[#666] text-xs sm:text-sm line-clamp-2">{bio}</p> : null}
            <div className="flex items-center gap-1 mt-1 sm:mt-2 text-xs sm:text-sm">
              ...
              <p className="text-text-primary text-sm">({totalFeedbacks} reviews)</p>
            </div>
          </div>
          ...
          <button
            ...
            className="border border-chip_text text-chip_text rounded-[10px] px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm hover:bg-chip-background transition whitespace-nowrap flex-shrink-0 disabled:cursor-not-allowed disabled:opacity-50"
          >
            View Profile
          </button>
        </div>
