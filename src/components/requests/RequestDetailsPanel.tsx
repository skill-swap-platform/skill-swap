            ...
            <div className="bg-white flex gap-[16px] h-[72px] items-center rounded-[5px] w-full">
              ...
              <div className="flex flex-1 flex-col gap-[4px] items-start justify-center min-w-0">
                <div className="flex flex-col items-start w-full">
                  <p className="font-medium text-[16px] leading-[normal] text-black h-[16px] w-full truncate">
                    {request.userName}
                  </p>
                </div>
            ...
            <div className="bg-white flex gap-[16px] h-[72px] items-center rounded-[5px] w-full">
              ...
              <div className="flex flex-1 flex-col gap-[4px] items-start justify-center min-w-0">
                <div className="flex flex-col gap-[4px] items-start w-full">
                  ...
                  <p className="font-medium text-[14px] leading-[normal] text-[#5e5e5f] h-[15px] truncate">
