 ...
 * 
 * The Avatar component provides an intelligent fallback system for user profile images.
 * When an image fails to load or is missing, it automatically generates a personalized
 * avatar using the DiceBear API based on the user's name.
 */
