                        ...
                        <>
                            ...
                            <div className="border border-gray-100 rounded-2xl p-4 flex items-center gap-4 mb-8 bg-white">
                                ...
                                <div>
                                    {isLoading ? (
                                        <>
                                            <div className="h-5 w-32 bg-gray-100 animate-pulse rounded mb-1.5" />
                                ...
                                <div className="border-l-[3px] border-[#3E8FCC] pl-5 py-1">
                                    {isLoading ? (
                                        <div className="space-y-2">
                                            ...
                                            <div className="h-4 w-[90%] bg-gray-50 animate-pulse rounded" />
                                            <div className="h-4 w-[80%] bg-gray-50 animate-pulse rounded" />
                                        </div>
                                    ) : (
                            ...
                            <div className="mb-10">
                                ...
                                <div className="space-y-3">
                                    {isLoading ? (
                                        [1, 2, 3].map(i => <div key={i} className="h-16 w-full bg-gray-50 border border-gray-50 rounded-xl animate-pulse" />)
                                    ) : (
                                        <>
                                            <DetailItem
